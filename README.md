...
The “*==Run” line is a flag; you should run all the codes from “*----->Defining” to “/*END*/” for each block (it will not work correctly if you run the section after “*==Run” separately). 
Errors
